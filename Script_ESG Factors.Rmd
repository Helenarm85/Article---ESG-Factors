...
cat("Máximo ROE (limpa):", max(df_limpa_sem_wins$ROE, na.rm=T), "\n")
...
modelo_painel_winsorized <- feglm(Empresa_ESG ~ Dividend_Yield + Debt_Assets + ROA + ROE + 
                         Gross_Margin + EBITDA_Margin + Net_Margin + log_Total_Assets + 
                         Dummy_Tem_ESG | Nome + Data,
                       data = df_limpa_sem_wins, # Using df_final or df_winsorized based on preference
                       family = binomial("logit"))
