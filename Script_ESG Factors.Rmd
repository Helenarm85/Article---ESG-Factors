...
```{r results='asis'}
modelsummary(
  title = "Pooled Probit Model: Entry Criterion (Y ≥ 20%) ",
...
modelsummary(
  title = "Pooled Probit Model: Entry Criterion (Y ≥ 20%) - Winsorized",
...
modelsummary(
  title = "Fixed Effects Probit Estimation: Entry Criterion (Y ≥ 20%)",
...
modelsummary(
  title = "Fixed Effects Probit Estimation: Entry Criterion (Y ≥ 20%) - Winsorized",
