...
library(bife)      # Binary Fixed Effects
...
obter_empresas_esg_por_data <- function(col_alvo, data_ref, lista_sheets) {
  ...
  corte_minimo <- qtd_fundos_ativos_data * 0.2  # 10%, 1% ou 20%
...
modelsummary(
  title = "Pooled Logit Model: Entry Criterion (Y ≥ 20%) - Without Outliers",
...
modelsummary(
  title = "Fixed Effects Logit Estimation: Entry Criterion (Y ≥ 20%) - Without Outliers",
